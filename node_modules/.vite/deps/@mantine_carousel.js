import {
  ...
  useRandomClassName,
  useStyles
} from "./chunk-DVEZK377.js";
import {
  clamp
} from "./chunk-TAO76LWV.js";
...
var Carousel_module_default = classes;
...
var Carousel = factory((_props, ref) => {
  ...
  const indicators = Array(slidesCount).fill(0).map((_, index) => import_react4.default.createElement(
    UnstyledButton,
    __spreadProps(__spreadValues2({}, getStyles("indicator")), {
      key: index,
  ...
  return import_react4.default.createElement(CarouselProvider, { value: { getStyles, orientation } }, import_react4.default.createElement(CarouselVariables, __spreadProps(__spreadValues2({}, props), { selector: `.${responsiveClassName}` })), import_react4.default.createElement(
    Box,
    __spreadProps(__spreadValues2(__spreadValues2({
      ref
    }, getStyles("root", { className: responsiveClassName })), others), {
      mod: { orientation, "include-gap-in-size": includeGapInSize },
      onKeyDownCapture: handleKeydown
    }),
    import_react4.default.createElement("div", __spreadProps(__spreadValues2({}, getStyles("viewport")), { ref: emblaRefElement }), import_react4.default.createElement("div", __spreadProps(__spreadValues2({}, getStyles("container")), { "data-orientation": orientation }), children)),
    withIndicators && import_react4.default.createElement("div", __spreadValues2({}, getStyles("indicators")), indicators),
    withControls && import_react4.default.createElement("div", __spreadValues2({}, getStyles("controls")), import_react4.default.createElement(
      UnstyledButton,
      __spreadProps(__spreadValues2(__spreadValues2({}, previousControlProps), getStyles("control", {
      ...
      UnstyledButton,
      __spreadProps(__spreadValues2(__spreadValues2({}, getStyles("control", {
